    ...
    <div class="flex-1 overflow-y-auto p-6 space-y-4 text-gray-800 font-medium text-sm">
        ...
        <div>
            ...
            <ul id="tentang" class="dropdown-mobile-menu hidden mt-2 pl-6 space-y-2 text-sm text-gray-600">
                <li><a href="{{ route('tentangkami.index') }}" class="block py-1 hover:text-blue-600">Profil</a></li>
                <li><a href="{{ route('tentangkami.visiMisi') }}" class="block py-1 hover:text-blue-600">Visi & Misi</a></li>
                <li><a href="{{ route('tentangkami.sejarah') }}" class="block py-1 hover:text-blue-600">Sejarah</a></li>
                <li><a href="{{ route('struktur.organisasi') }}" class="block py-1 hover:text-blue-600">Struktur Organisasi</a></li>
                <li><a href="{{ route('struktur.gtk') }}" class="block py-1 hover:text-blue-600">GTK</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul id="dokumentasi" class="dropdown-mobile-menu hidden mt-2 pl-6 space-y-2 text-sm text-gray-600">
                <li><a href="{{ route('galeri.index') }}" class="block py-1 hover:text-blue-600">Galeri</a></li>
                <li><a href="#" class="block py-1 hover:text-blue-600">Video</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul id="informasi" class="dropdown-mobile-menu hidden mt-2 pl-6 space-y-2 text-sm text-gray-600">
                <li><a href="{{ route('informasi.berita') }}" class="block py-1 hover:text-blue-600">Berita</a></li>
                <li><a href="#" class="block py-1 hover:text-blue-600">Pengumuman</a></li>
            </ul>
        </div>
